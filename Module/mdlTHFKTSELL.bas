Attribute VB_Name = "mdlTHFKTSELL"
Option Explicit

Public Sub DeleteTHFKTSELL(ByRef rstMain As ADODB.Recordset)
    ...
    With rstTemp
        ...
        Set rstDetail = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTDFKTSELL, False, "FktId='" & rstMain!FktId & "'")
...
Public Function RestoreTHFKTSELL(ByVal strRecycleId As String) As Boolean
    If Not mdlGlobal.UserAuthority.IsMenuAccess(mdiMain.mnuTHFKTSELL.Name) Then
        RestoreTHFKTSELL = False
    ...
    If Not mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMCUSTOMER, "CustomerId='" & Trim(rstTemp!OptInfoFirst) & "'") Then
        blnValid = False
    End If
    ...
    If blnValid Then
        With rstTemp
            ...
            Set rstHeader = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHFKTSELL, , "FktId='" & Trim(!ReferencesNumber) & "'")
    ...
    If blnValid Then
        ...
        With rstTemp
            ...
            While Not .EOF
                ...
                Set rstDetail = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTDFKTSELL, , "FktDtlId='" & strFktDtlId & "'")
