...
Begin VB.Form frmTMCUSTOMERNOTES 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7605
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   8970
   Icon            =   "frmTMCUSTOMERNOTES.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7605
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCUSTOMERNOTES.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCUSTOMERNOTES.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCUSTOMERNOTES.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCUSTOMERNOTES.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCUSTOMERNOTES.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCUSTOMERNOTES.frx":D524
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTMCUSTOMERNOTES"
...
Private PrintMaster As clsPRTTMCUSTOMERNOTES
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmTMCUSTOMERNOTES = Nothing
End Sub
...
Private Sub SetInitialization()
    ...
    If frmTMCUSTOMER.Parent Then
        ...
        strCriteria = "CustomerId='" & frmTMCUSTOMER.CustomerId & "'"
    ElseIf frmMISTMCUSTOMER.Parent Then
        Me.txtCustomerId.Caption = frmMISTMCUSTOMER.CustomerId & " | " & frmMISTMCUSTOMER.CustomerName
        
        strCriteria = "CustomerId='" & frmMISTMCUSTOMER.CustomerId & "'"
    End If
    
    strFormCaption = mdlText.strTMCUSTOMERNOTES
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCUSTOMERNOTES, , strCriteria, "NotesDate ASC")
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMCUSTOMERNOTES
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCUSTOMERNOTES, , strCriteria, "NotesDate ASC")
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If frmMISTMCUSTOMER.Parent Then
            frmMISTMCUSTOMER.CustomerId = frmMISTMCUSTOMER.CustomerId
        End If
    End If
...
Private Sub SaveFunction()
    ...
    With rstMain
        ...
        ElseIf frmMISTMCUSTOMER.Parent Then
            strCustomerId = frmMISTMCUSTOMER.CustomerId
        End If
        
        mdlDatabase.SearchRecordset rstMain, "NotesId", strCustomerId & mdlProcedures.FormatDate(Me.dtpNotesDate.Value, "ddMMyyyy") & mdlProcedures.FormatDate(Me.dtpNotesTime.Value, "hhmmss")
        
        If .EOF Then
            .AddNew
            
            !NotesId = strCustomerId & mdlProcedures.FormatDate(Me.dtpNotesDate.Value, "ddMMyyyy") & mdlProcedures.FormatDate(Me.dtpNotesDate.Value, "hhmmss")
            !CustomerId = Trim(strCustomerId)
...
Private Function CheckValidation() As Boolean
    ...
    If objMode = AddMode Then
        With rstMain
            ...
            mdlDatabase.SearchRecordset rstMain, "NotesId", strCustomerId & mdlProcedures.FormatDate(Me.dtpNotesDate.Value, "ddMMyyyy") & mdlProcedures.FormatDate(Me.dtpNotesDate.Value, "hhmmss")
