...
Begin VB.Form frmRPTTHSJBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   2655
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9270
   Icon            =   "frmRPTTHSJBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRPTTHSJBUY"
...
Private PrintReport As clsRPTTHSJBUY
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strRPTTHSJBUY
...
Private Sub SetPrint()
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHSJBUY, False, strCriteria, "SJId ASC")
    ...
    Else
        ...
        Set PrintReport = New clsRPTTHSJBUY
