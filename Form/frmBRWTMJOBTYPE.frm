...
Begin VB.Form frmBRWTMJOBTYPE 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   5295
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8670
   Icon            =   "frmBRWTMJOBTYPE.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5295
   ...
   End
End
Attribute VB_Name = "frmBRWTMJOBTYPE"
...
Private Sub dgdMain_HeadClick(ByVal ColIndex As Integer)
    ...
    If rstMain.RecordCount > 0 Then
        If frmTMJOBTYPE.Parent Then
            frmTMJOBTYPE.JobTypeId = rstMain!JobTypeId
        ElseIf frmTMEMPLOYEE.Parent Then
            frmTMEMPLOYEE.JobTypeIdCombo = rstMain!JobTypeId
        End If
    End If
End Sub
...
Private Sub cmdCancel_Click()
    If frmTMJOBTYPE.Parent Then
        frmTMJOBTYPE.JobTypeId = strParent
    ElseIf frmTMEMPLOYEE.Parent Then
        frmTMEMPLOYEE.JobTypeIdCombo = strParent
    End If
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strBRWTMJOBTYPE

    If frmTMJOBTYPE.Parent Then
        Me.txtJobTypeId.Text = Trim(frmTMJOBTYPE.JobTypeId)
        Me.txtName.Text = Trim(frmTMJOBTYPE.JobTypeName)
        
        strParent = Trim(frmTMJOBTYPE.JobTypeId)
    ElseIf frmTMEMPLOYEE.Parent Then
        strParent = Trim(frmTMEMPLOYEE.JobTypeIdCombo)
    End If
...
Private Sub SetGrid()
    ...
    If Not Trim(Me.txtJobTypeId.Text) = "" Then
        strCriteria = mdlProcedures.QueryLikeCriteria("JobTypeId", mdlProcedures.RepDupText(Me.txtJobTypeId.Text))
    End If
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "JobTypeId, Name", mdlTable.CreateTMJOBTYPE, False, strCriteria, "JobTypeId ASC")
