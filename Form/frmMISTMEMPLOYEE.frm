...
Begin VB.Form frmMISTMEMPLOYEE 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   4815
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   8685
   Icon            =   "frmMISTMEMPLOYEE.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTMEMPLOYEE"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTMEMPLOYEE
