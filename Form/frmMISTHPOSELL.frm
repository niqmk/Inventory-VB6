...
Begin VB.Form frmMISTHPOSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7710
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9150
   Icon            =   "frmMISTHPOSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHPOSELL"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHPOSELL
    ...
    If frmReminderList.Parent Then
        Me.txtPOId.Text = frmReminderList.POId
        mdlProcedures.SetComboData Me.cmbCustomerId, frmReminderList.POCustomer
        Me.dtpStartDate.Value = mdlProcedures.FormatDate(frmReminderList.PODate)
...
Private Sub SetGridHeader(Optional ByVal blnInitialize As Boolean = True)
    ...
    Set rstHeader = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "POId, PODate, Name", strTable, False, strCriteria, "POId ASC")
