...
Begin VB.Form frmMISTHRTRSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9270
   Icon            =   "frmMISTHRTRSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHRTRSELL"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHRTRSELL
...
Private Sub SetGridHeader(Optional ByVal blnInitialize As Boolean = True)
    ...
    Set rstHeader = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "RtrId, RtrDate, SJId", mdlTable.CreateTHRTRSELL, False, strCriteria, "RtrId")
...
Private Sub SetGridDetail(Optional ByVal strRtrId As String = "")
    ...
    strTableFirst = mdlTable.CreateTDRTRSELL
