...
Begin VB.Form frmTDDOBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7455
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8895
   Icon            =   "frmTDDOBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7455
...
Private Sub cmdSave_Click()
    ...
    frmTHDOBUY.SaveDetail rstMain!ItemId, mdlProcedures.GetCurrency(Me.txtQty.Text)
End Sub

Private Sub SetInitialization()
    mdlProcedures.CenterWindows Me, False
    
    Me.Caption = mdlText.strTDDOBUY
...
Private Sub SetGrid(Optional ByVal blnInitialize As Boolean = True)
    ...
    If frmTHDOBUY.Parent Then
        ...
        strCriteria = strCriteria & "POId='" & frmTHDOBUY.POIdCombo & "'"
    End If
    ...
    With rstTemp
        While Not .EOF
            ...
            rstMain!Name = !Name
            rstMain!Qty = mdlProcedures.GetCurrency(!Qty) - mdlTHDOBUY.GetQtyPOFromDOBUY(!POId, !ItemId)
...
Private Sub FillText(Optional ByVal blnClear As Boolean = False)
    ...
    Else
        With rstMain
            ...
            Me.txtStockQty.Caption = mdlTransaction.CheckStock(!ItemId, frmTHDOBUY.WarehouseIdCombo)
        End With
    End If
End Sub
