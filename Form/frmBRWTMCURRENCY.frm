...
Begin VB.Form frmBRWTMCURRENCY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   5295
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   8670
   Icon            =   "frmBRWTMCURRENCY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5295
   ...
   End
End
Attribute VB_Name = "frmBRWTMCURRENCY"
...
Private Sub dgdMain_HeadClick(ByVal ColIndex As Integer)
    ...
    If rstMain.RecordCount > 0 Then
        If frmTMCURRENCY.Parent Then
            frmTMCURRENCY.CurrencyId = rstMain!CurrencyId
        ElseIf frmTMITEMPRICE.Parent Then
            frmTMITEMPRICE.CurrencyIdCombo = rstMain!CurrencyId
        ElseIf frmTHPOBUY.Parent Then
            frmTHPOBUY.CurrencyIdCombo = rstMain!CurrencyId
        ElseIf frmTHSOSELL.Parent Then
            frmTHSOSELL.CurrencyIdCombo = rstMain!CurrencyId
        End If
    End If
End Sub
...
Private Sub cmdCancel_Click()
    If frmTMCURRENCY.Parent Then
        frmTMCURRENCY.CurrencyId = strParent
    ElseIf frmTMITEMPRICE.Parent Then
        frmTMITEMPRICE.CurrencyIdCombo = strParent
    ElseIf frmTHPOBUY.Parent Then
        frmTHPOBUY.CurrencyIdCombo = strParent
    ElseIf frmTHSOSELL.Parent Then
        frmTHSOSELL.CurrencyIdCombo = strParent
    End If
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strBRWTMCURRENCY

    If frmTMCURRENCY.Parent Then
        Me.txtCurrencyId.Text = Trim(frmTMCURRENCY.CurrencyId)
        Me.txtName.Text = Trim(frmTMCURRENCY.CurrencyName)
        
        strParent = Trim(frmTMCURRENCY.CurrencyId)
    ElseIf frmTMITEMPRICE.Parent Then
        strParent = Trim(frmTMITEMPRICE.CurrencyIdCombo)
    ElseIf frmTHPOBUY.Parent Then
        strParent = Trim(frmTHPOBUY.CurrencyIdCombo)
    ElseIf frmTHSOSELL.Parent Then
        strParent = Trim(frmTHSOSELL.CurrencyIdCombo)
    End If
...
Private Sub SetGrid()
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "CurrencyId, Name", mdlTable.CreateTMCURRENCY, False, strCriteria, "CurrencyId ASC")
