...
Begin VB.Form frmRPTTHPOSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   2295
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9150
   Icon            =   "frmRPTTHPOSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRPTTHPOSELL"
...
Private PrintReport As clsRPTTHPOSELL
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strRPTTHPOSELL
...
Private Sub SetPrint()
    ...
    Else
        ...
        Set PrintReport = New clsRPTTHPOSELL
