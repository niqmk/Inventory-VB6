...
Begin VB.Form frmRPTTHITEMIN 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   1950
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9030
   Icon            =   "frmRPTTHITEMIN.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRPTTHITEMIN"
...
Private PrintReport As clsRPTTHITEMIN
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strRPTTHITEMIN
...
Private Sub SetPrint()
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "ItemInId, ItemInDate, WarehouseId", mdlTable.CreateTHITEMIN, False, strCriteria, "ItemInDate ASC")
    ...
    Else
        ...
        Set PrintReport = New clsRPTTHITEMIN
