...
Begin VB.Form frmMISTHITEMOUT 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9015
   Icon            =   "frmMISTHITEMOUT.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHITEMOUT"
...
Private Sub dgdHeader_HeadClick(ByVal ColIndex As Integer)
    ...
    If rstHeader.RecordCount > 0 Then
        SetGridDetail rstHeader!ItemOutId
    Else
        SetGridDetail
    End If
End Sub
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHITEMOUT
...
Private Sub SetGridHeader(Optional ByVal blnInitialize As Boolean = True)
    ...
    With rstTemp
        While Not .EOF
            ...
            rstHeader!ItemOutId = !ItemOutId
            rstHeader!ItemOutDate = mdlProcedures.FormatDate(!ItemOutDate)
...
Private Sub SetGridDetail(Optional ByVal strItemOutId As String = "")
    Dim strTableFirst As String
    Dim strTableSecond As String
    Dim strTable As String
    
    strTableFirst = mdlTable.CreateTDITEMOUT
