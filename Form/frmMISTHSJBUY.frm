...
Begin VB.Form frmMISTHSJBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9270
   Icon            =   "frmMISTHSJBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHSJBUY"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHSJBUY
...
Private Sub SetGridHeader(Optional ByVal blnInitialize As Boolean = True)
    ...
    Else
        ...
        If Not Trim(Me.txtDOId.Text) = "" Then
            ...
            strCriteria = strCriteria & mdlProcedures.QueryLikeCriteria("DOId", mdlProcedures.RepDupText(Me.txtDOId.Text))
        End If
        ...
        If mdlProcedures.IsValidComboData(Me.cmbVendorId) Then
            ...
            strCriteria = strCriteria & "DOId IN (SELECT DOId FROM " & mdlTable.CreateTHDOBUY & " WHERE POId IN (SELECT POId FROM " & mdlTable.CreateTHPOBUY & " WHERE VendorId='" & mdlProcedures.GetComboData(Me.cmbVendorId) & "'))"
        End If
    ...
    Set rstHeader = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "SJId, SJDate, DOId", mdlTable.CreateTHSJBUY, False, strCriteria, "SJId ASC")
