...
Begin VB.Form frmMISTHFKTSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7590
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9375
   Icon            =   "frmMISTHFKTSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHFKTSELL"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHFKTSELL
...
Private Sub SetGridDetail(Optional ByVal strFktId As String = "")
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "SJId", mdlTable.CreateTDFKTSELL, False, strCriteria, "SJId ASC")
    ...
    With rstTemp
        While Not .EOF
            ...
            rstDetail!SJId = !SJId
            rstDetail!SJDate = mdlDatabase.GetFieldData(mdlGlobal.conInventory, "SJDate", mdlTable.CreateTHSJSELL, "SJId='" & !SJId & "'")
            rstDetail!Qty = mdlTHSJSELL.GetTotalQtySJSELL(!SJId)
