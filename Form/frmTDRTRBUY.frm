...
Begin VB.Form frmTDRTRBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7605
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8925
   Icon            =   "frmTDRTRBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7605
...
Private Sub cmdSave_Click()
    ...
    frmTHRTRBUY.SaveDetail rstMain!ItemId, mdlProcedures.GetCurrency(Me.txtQty.Text)
End Sub
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strTDRTRBUY
    
    Dim strWarehouseId As String
    
    strWarehouseId = mdlDatabase.GetFieldData(mdlGlobal.conInventory, "WarehouseId", mdlTable.CreateTHDOBUY, "DOId='" & _
        mdlDatabase.GetFieldData(mdlGlobal.conInventory, "DOId", mdlTable.CreateTHSJBUY, "SJId='" & frmTHRTRBUY.SJIdCombo & "'") & "'")
...
Private Sub SetGrid(Optional ByVal blnInitialize As Boolean = True)
    ...
    strTableFirst = mdlTable.CreateTDSJBUY
    ...
    strCriteria = strCriteria & "SJId='" & frmTHRTRBUY.SJIdCombo & "'"
    ...
    With rstTemp
        While Not .EOF
            ...
            rstMain!Name = !Name
            rstMain!Qty = mdlProcedures.GetCurrency(!Qty) - mdlTHRTRBUY.GetQtySJFromRTRBUY(!SJId, !ItemId)
...
Private Sub FillText(Optional ByVal blnClear As Boolean = False)
    ...
    Else
        With rstMain
            ...
            Me.txtStockQty.Caption = mdlProcedures.FormatCurrency(mdlTransaction.CheckStock(!ItemId, mdlProcedures.SplitData(Me.txtWarehouseId)))
            Me.txtUnityId.Caption = mdlDatabase.GetFieldData(mdlGlobal.conInventory, "UnityId", mdlTable.CreateTMITEM, "ItemId='" & !ItemId & "'")
        End With
    End If
End Sub
