...
Begin VB.Form frmTMSTOCKINIT 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7725
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13590
   Icon            =   "frmTMSTOCKINIT.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":B674
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMSTOCKINIT.frx":DAC6
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTMSTOCKINIT"
...
Private PrintMaster As clsPRTTMSTOCKINIT
...
Private Sub Form_Activate()
    ...
    If rstMain.RecordCount > 0 Then
        ...
        mdlProcedures.ShowForm frmBRWTMSTOCKINIT, False, True
    End If
...
Private Sub tlbMain_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case BrowseButton:
            ...
            mdlProcedures.ShowForm frmBRWTMSTOCKINIT, False
        Case SaveButton:
            SaveFunction
        Case CancelButton:
            objMode = ViewMode
...
Private Sub txtItemId_Validate(Cancel As Boolean)
    ...
    Else
        ...
        strUnityId = mdlDatabase.GetFieldData(mdlGlobal.conInventory, "UnityId", mdlTable.CreateTMITEM, "ItemId='" & mdlProcedures.RepDupText(Me.txtItemId.Text) & "'")
...
Private Sub SetInitialization()
    ...
    strFormCaption = mdlText.strTMSTOCKINIT
...
Private Sub FillComboTMWAREHOUSE()
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "WarehouseId, Name", mdlTable.CreateTMWAREHOUSE)
...
Private Sub SetRecordset()
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMSTOCKINIT, , "WarehouseId='" & Me.WarehouseIdCombo & "'", "ItemId ASC")
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMSTOCKINIT
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMSTOCKINIT, , "WarehouseId='" & Me.WarehouseIdCombo & "'", "ItemId ASC")
...
Private Sub SaveFunction()
    ...
    With rstMain
        ...
        strItemId = _
            strItemId & _
            Space(mdlDatabase.GetColumnSize(mdlGlobal.conInventory, "ItemId", mdlTable.CreateTMSTOCKINIT) - Len(strItemId))
        
        strWarehouseId = Me.WarehouseIdCombo
    
        mdlDatabase.SearchRecordset rstMain, "StockInitId", strItemId & strWarehouseId
        
        If .EOF Then
            .AddNew
            
            !StockInitId = strItemId & strWarehouseId
...
Private Function CheckValidation() As Boolean
    ...
    If objMode = AddMode Then
        ...
        strItemId = mdlProcedures.RepDupText(Trim(Me.txtItemId.Text))
        strItemId = strItemId & Space(mdlDatabase.GetColumnSize(mdlGlobal.conInventory, "ItemId", mdlTable.CreateTMITEM) - Len(strItemId))
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMSTOCKINIT, "StockInitId='" & strItemId & strWarehouseId & "'") Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            ...
            Me.txtQty.Text = mdlProcedures.FormatCurrency(!Qty)
        End If
    End With
End Sub
...
Private Sub ArrangeGrid()
    ...
    With Me.dgdMain
        ...
        For intCounter = 4 To Me.dgdMain.Columns.Count - 1
