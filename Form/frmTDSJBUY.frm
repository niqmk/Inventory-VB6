...
Begin VB.Form frmTDSJBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7680
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8925
   Icon            =   "frmTDSJBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7680
...
Private Sub cmdSave_Click()
    ...
    frmTHSJBUY.SaveDetail rstMain!ItemId, mdlProcedures.GetCurrency(Me.txtQty.Text)
End Sub
...
Private Function CheckValidation() As Boolean
    If rstMain.RecordCount > 0 Then
        ...
        If Not (mdlProcedures.GetCurrency(Me.txtDOQty.Caption) >= curQty) Then
            MsgBox "Qty Melebihi Qty DO", vbOKOnly + vbExclamation, Me.Caption
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strTDSJBUY
    
    blnParent = False
    
    Me.txtWarehouseId.Caption = frmTHSJBUY.WarehouseId & " | " & mdlDatabase.GetFieldData(mdlGlobal.conInventory, "Name", mdlTable.CreateTMWAREHOUSE, "WarehouseId='" & frmTHSJBUY.WarehouseId & "'")
...
Private Sub SetGrid(Optional ByVal blnInitialize As Boolean = True)
    ...
    strTableFirst = mdlTable.CreateTDDOBUY
    ...
    strCriteria = strCriteria & "DOId='" & frmTHSJBUY.DOIdCombo & "'"
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, strTableFirst & ".ItemId, PartNumber, " & strTableSecond & ".Name, Qty, DOId", strTable, False, strCriteria, strTableFirst & ".ItemId ASC")
    ...
    With rstTemp
        While Not .EOF
            ...
            rstMain!Name = !Name
            rstMain!Qty = mdlProcedures.GetCurrency(!Qty) - mdlTHSJBUY.GetQtyDOFromSJBUY(!DOId, !ItemId)
...
Private Sub FillText(Optional ByVal blnClear As Boolean = False)
    ...
    Else
        With rstMain
            ...
            Me.txtDOQty.Caption = mdlProcedures.FormatCurrency(!Qty)
            Me.txtStockQty.Caption = mdlProcedures.FormatCurrency(mdlTransaction.CheckStock(!ItemId, frmTHSJBUY.WarehouseId))
