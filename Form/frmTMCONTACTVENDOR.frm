...
Begin VB.Form frmTMCONTACTVENDOR 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   6510
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8790
   Icon            =   "frmTMCONTACTVENDOR.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6510
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCONTACTVENDOR.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCONTACTVENDOR.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCONTACTVENDOR.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCONTACTVENDOR.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCONTACTVENDOR.frx":B0D2
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTMCONTACTVENDOR"
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmTMCONTACTVENDOR = Nothing
End Sub
...
Private Sub SetInitialization()
    ...
    Me.txtVendorId.Caption = frmTMVENDOR.VendorId & " | " & frmTMVENDOR.VendorName
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCONTACTVENDOR, , "VendorId='" & frmTMVENDOR.VendorId & "'", "Name ASC")
    
    ArrangeGrid
    
    strFormCaption = mdlText.strTMCONTACTVENDOR
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "ContactId", frmTMVENDOR.VendorId & mdlProcedures.RepDupText(Trim(Me.txtName.Text))
        
        If .EOF Then
            .AddNew
            
            !ContactId = frmTMVENDOR.VendorId & mdlProcedures.RepDupText(Trim(Me.txtName.Text))
            !VendorId = Trim(frmTMVENDOR.VendorId)
