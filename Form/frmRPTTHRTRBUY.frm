...
Begin VB.Form frmRPTTHRTRBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   2655
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9270
   Icon            =   "frmRPTTHRTRBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRPTTHRTRBUY"
...
Private PrintReport As clsRPTTHRTRBUY
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strRPTTHRTRBUY
...
Private Sub SetPrint()
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHRTRBUY, False, strCriteria, "RtrId ASC")
    ...
    Else
        ...
        Set PrintReport = New clsRPTTHRTRBUY
