...
Begin VB.Form frmBRWTHFKTBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   6750
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9390
   Icon            =   "frmBRWTHFKTBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6750
   ...
   End
End
Attribute VB_Name = "frmBRWTHFKTBUY"
...
Private Sub dgdMain_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    If rstMain.RecordCount > 0 Then
        If frmTHFKTBUY.Parent Then
            frmTHFKTBUY.FktId = rstMain!FktId
        ElseIf frmTHRTRBUY.Parent Then
            frmTHRTRBUY.FktIdCombo = rstMain!FktId
        End If
    End If
End Sub
...
Private Sub cmdCancel_Click()
    If frmTHFKTBUY.Parent Then
        frmTHFKTBUY.FktId = strParent
    ElseIf frmTHRTRBUY.Parent Then
        frmTHRTRBUY.FktIdCombo = strParent
    End If
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strBRWTHFKTBUY
    ...
    If frmTHFKTBUY.Parent Then
        Me.txtFktId.Text = Trim(frmTHFKTBUY.FktId)
        
        mdlProcedures.SetComboData Me.cmbVendorId, frmTHFKTBUY.VendorIdCombo
        
        strYear = frmTHFKTBUY.YearTrans
        strMonth = frmTHFKTBUY.MonthTrans
        
        strParent = Trim(frmTHFKTBUY.FktId)
    ElseIf frmTHRTRBUY.Parent Then
        ...
        strParent = Trim(frmTHRTRBUY.FktIdCombo)
    End If
...
Private Sub SetGrid()
    ...
    If frmTHFKTBUY.Parent Then
        ...
        strCriteria = strCriteria & "MONTH(FktDate)=" & frmTHFKTBUY.MonthTrans & " AND YEAR(FktDate)=" & frmTHFKTBUY.YearTrans
    End If
