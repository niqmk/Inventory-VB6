...
Begin VB.Form frmTMCURRENCY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   3495
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   7830
   Icon            =   "frmTMCURRENCY.frx":0000
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ScaleHeight     =   3495
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":B674
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":FDAE
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCURRENCY.frx":12200
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTMCURRENCY"
...
Private PrintMaster As clsPRTTMCURRENCY
...
Private Sub tlbMain_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case ConvertButton:
            ...
            mdlProcedures.ShowForm frmTMCONVERTCURRENCY, False, True
        Case SaveButton:
            SaveFunction
        Case CancelButton:
            objMode = ViewMode
...
Private Sub txtCurrencyId_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub SetInitialization()
    ...
    With Me.tlbMain
        ...
        .Buttons.Add ConvertButton, , "Nilai Tukar", , ConvertButton
        .Buttons.Add SaveButton, , "Simpan", , SaveButton
        .Buttons.Add CancelButton, , "Batal", , CancelButton
    End With
    
    strFormCaption = mdlText.strTMCURRENCY
    
    blnParent = False
    blnActivate = False
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCURRENCY, , , "CurrencyId ASC")
...
Private Sub SetMode()
    ...
    With Me.tlbMain
        ...
        .Buttons(ConvertButton).Visible = blnFront
    ...
    If objMode = AddMode Then
        ...
        Me.txtCurrencyId.SetFocus
    ElseIf objMode = UpdateMode Then
        Me.fraHeader.Enabled = False
        
        mdlProcedures.SetControlMode Me, objMode, False, Me.txtCurrencyId.Name
    ...
    If rstMain.RecordCount > 0 Then
        With Me.tlbMain
            ...
            .Buttons(ConvertButton).Enabled = True
        End With
    ...
    Else
        With Me.tlbMain
            ...
            .Buttons(ConvertButton).Enabled = False
        End With
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMCURRENCY
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCURRENCY, False, , "CurrencyId ASC")
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMITEMPRICE, "CurrencyId='" & rstMain!CurrencyId & "'") Then
            MsgBox strMessage & mdlText.strTMITEMPRICE & ")", vbCritical + vbOKOnly, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        ElseIf mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMPRICELIST, "CurrencyId='" & rstMain!CurrencyId & "'") Then
            MsgBox strMessage & mdlText.strTMPRICELIST & ")", vbCritical + vbOKOnly, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        ElseIf mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTHPOBUY, "CurrencyId='" & rstMain!CurrencyId & "'") Then
            MsgBox strMessage & mdlText.strTHPOBUY & ")", vbCritical + vbOKOnly, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        ElseIf mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTHSOSELL, "CurrencyId='" & rstMain!CurrencyId & "'") Then
            MsgBox strMessage & mdlText.strTHSOSELL & ")", vbCritical + vbOKOnly, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        Else
            mdlDatabase.DeleteRecordQuery mdlGlobal.conInventory, mdlTable.CreateTMCONVERTCURRENCY, "CurrencyFromId='" & rstMain!CurrencyId & "' OR CurrencyToId='" & rstMain!CurrencyId & "'"
            mdlDatabase.DeleteSingleRecord rstMain
            
            If frmTMITEMPRICE.Parent Then
                frmTMITEMPRICE.FillComboTMCURRENCY
            End If
            
            If frmTMPRICELIST.Parent Then
                frmTMPRICELIST.FillComboTMCURRENCY
            End If
            
            If frmTHPOBUY.Parent Then
                frmTHPOBUY.FillComboTMCURRENCY
            End If
            
            If frmTHSOSELL.Parent Then
                frmTHSOSELL.FillComboTMCURRENCY
            End If
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "CurrencyId", mdlProcedures.RepDupText(Trim(Me.txtCurrencyId.Text))
        
        If .EOF Then
            .AddNew
            
            !CurrencyId = mdlProcedures.RepDupText(Trim(Me.txtCurrencyId.Text))
...
Private Function CheckValidation() As Boolean
    If mdlProcedures.RepDupText(Trim(Me.txtCurrencyId.Text)) = "" Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            Me.txtCurrencyId.Text = Trim(!CurrencyId)
...
Public Property Let CurrencyId(ByVal strCurrencyId As String)
    ...
    mdlDatabase.SearchRecordset rstMain, "CurrencyId", strCurrencyId
