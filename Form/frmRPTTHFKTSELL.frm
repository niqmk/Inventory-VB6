...
Begin VB.Form frmRPTTHFKTSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   2310
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9405
   Icon            =   "frmRPTTHFKTSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRPTTHFKTSELL"
...
Private PrintReport As clsRPTTHFKTSELL
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strRPTTHFKTSELL
...
Private Sub SetPrint()
    ...
    If mdlProcedures.IsValidComboData(Me.cmbCustomerId) Then
        ...
        strCriteria = strCriteria & "CustomerId='" & mdlProcedures.GetComboData(Me.cmbCustomerId) & "'"
    End If
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHFKTSELL, False, strCriteria, "FktId ASC")
    ...
    Else
        ...
        Set PrintReport = New clsRPTTHFKTSELL
