...
Begin VB.Form frmMISTMCATEGORY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   4815
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   8670
   Icon            =   "frmMISTMCATEGORY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTMCATEGORY"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTMCATEGORY
