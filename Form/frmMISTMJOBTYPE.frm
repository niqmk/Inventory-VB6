...
Begin VB.Form frmMISTMJOBTYPE 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   4845
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   8670
   Icon            =   "frmMISTMJOBTYPE.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTMJOBTYPE"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTMJOBTYPE
