...
Begin VB.Form frmTMGROUP 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   3525
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "frmTMGROUP.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":B674
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMGROUP.frx":DAC6
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private PrintMaster As clsPRTTMGROUP
...
Private Sub txtGroupId_GotFocus()
    mdlProcedures.GotFocus Me.txtGroupId
End Sub
...
Private Sub txtGroupId_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub SetInitialization()
    ...
    strFormCaption = mdlText.strTMGROUP
    
    blnParent = False
    blnActivate = False
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMGROUP, , , "GroupId ASC")
...
Private Sub SetMode()
    ...
    If objMode = AddMode Then
        ...
        Me.txtGroupId.SetFocus
    ElseIf objMode = UpdateMode Then
        Me.fraHeader.Enabled = False
        
        mdlProcedures.SetControlMode Me, objMode, False, Me.txtGroupId.Name
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMGROUP
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMGROUP, False, , "GroupId ASC")
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMITEM, "GroupId='" & rstMain!GroupId & "'") Then
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "GroupId", mdlProcedures.RepDupText(Trim(Me.txtGroupId.Text))
        
        If .EOF Then
            .AddNew
            
            !GroupId = mdlProcedures.RepDupText(Trim(Me.txtGroupId.Text))
...
Private Function CheckValidation() As Boolean
    If mdlProcedures.RepDupText(Trim(Me.txtGroupId.Text)) = "" Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            Me.txtGroupId.Text = Trim(!GroupId)
...
Public Property Let GroupId(ByVal strGroupId As String)
    ...
    mdlDatabase.SearchRecordset rstMain, "GroupId", strGroupId
