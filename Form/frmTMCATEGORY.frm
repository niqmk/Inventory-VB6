...
Begin VB.Form frmTMCATEGORY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   3495
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "frmTMCATEGORY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":B674
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMCATEGORY.frx":DAC6
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTMCATEGORY"
...
Private PrintMaster As clsPRTTMCATEGORY
...
Private Sub txtCategoryId_GotFocus()
    mdlProcedures.GotFocus Me.txtCategoryId
End Sub
...
Private Sub txtCategoryId_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub SetInitialization()
    ...
    strFormCaption = mdlText.strTMCATEGORY
    
    blnParent = False
    blnActivate = False
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCATEGORY, , , "CategoryId ASC")
...
Private Sub SetMode()
    ...
    ElseIf objMode = UpdateMode Then
        ...
        mdlProcedures.SetControlMode Me, objMode, False, Me.txtCategoryId.Name
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMCATEGORY
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMCATEGORY, False, , "CategoryId ASC")
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMITEM, "CategoryId='" & rstMain!CategoryId & "'") Then
            MsgBox strMessage & mdlText.strTMITEM & ")", vbCritical + vbOKOnly, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        Else
            mdlDatabase.DeleteSingleRecord rstMain
            
            If frmTMITEM.Parent Then
                frmTMITEM.FillComboTMCATEGORY
            End If
        End If
    End If
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "CategoryId", mdlProcedures.RepDupText(Trim(Me.txtCategoryId.Text))
        
        If .EOF Then
            .AddNew
            
            !CategoryId = mdlProcedures.RepDupText(Trim(Me.txtCategoryId.Text))
    ...
    If frmTMITEM.Parent Then frmTMITEM.FillComboTMCATEGORY
End Sub

Private Function CheckValidation() As Boolean
    If mdlProcedures.RepDupText(Trim(Me.txtCategoryId.Text)) = "" Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            Me.txtCategoryId.Text = Trim(!CategoryId)
...
Public Property Let CategoryId(ByVal strCategoryId As String)
    If rstMain Is Nothing Then Exit Property
    
    mdlDatabase.SearchRecordset rstMain, "CategoryId", strCategoryId
