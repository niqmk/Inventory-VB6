...
Begin VB.Form frmTDPOSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   8070
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8910
   Icon            =   "frmTDPOSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8070
...
Private Sub cmdSave_Click()
    ...
    frmTHPOSELL.SaveDetail _
        rstMain!ItemId, _
        mdlProcedures.GetCurrency(Me.txtQty.Text)
End Sub
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strTDPOSELL
...
Private Sub FillText(Optional ByVal blnClear As Boolean = False)
    ...
    Else
        With rstMain
            ...
            Me.txtItemPrice.Caption = mdlProcedures.FormatCurrency(CStr(mdlProcedures.GetCurrency(mdlDatabase.GetFieldData(mdlGlobal.conInventory, "ItemPrice", mdlTable.CreateTMITEMPRICE, "ItemId='" & !ItemId & "'", "PriceDate DESC"))))
