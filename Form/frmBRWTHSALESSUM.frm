...
Begin VB.Form frmBRWTHSALESSUM 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   5910
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9150
   Icon            =   "frmBRWTHSALESSUM.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5910
   ...
   End
End
Attribute VB_Name = "frmBRWTHSALESSUM"
...
Private Sub dgdMain_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    If rstMain.RecordCount > 0 Then
        If frmTHSALESSUM.Parent Then
            frmTHSALESSUM.POId = rstMain!POId
        End If
    End If
End Sub
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strBRWTHSALESSUM
    ...
    If frmTHSALESSUM.Parent Then
        Me.txtPOId.Text = Trim(frmTHSALESSUM.POId)
        Me.txtPOCustomerId.Text = Trim(frmTHSALESSUM.POCustomerId)
        
        mdlProcedures.SetComboData Me.cmbCustomerId, frmTHSALESSUM.CustomerIdCombo
        
        strYear = frmTHSALESSUM.YearTrans
        strMonth = frmTHSALESSUM.MonthTrans
        
        strParent = Trim(frmTHSALESSUM.POId)
    End If
...
Private Sub SetGrid()
    ...
    If frmTHSALESSUM.Parent Then
        ...
        strCriteria = strCriteria & "MONTH(PODate)=" & frmTHSALESSUM.MonthTrans & " AND YEAR(PODate)=" & frmTHSALESSUM.YearTrans
    End If
