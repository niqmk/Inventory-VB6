...
Begin VB.Form frmTDITEMOUT 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7935
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9030
   Icon            =   "frmTDITEMOUT.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7935
   ...
   End
End
Attribute VB_Name = "frmTDITEMOUT"
...
Private Sub cmdSave_Click()
    ...
    frmTHITEMOUT.SaveDetail rstMain!ItemId, mdlProcedures.GetCurrency(Me.txtQty.Text)
End Sub

Private Sub SetInitialization()
    mdlProcedures.CenterWindows Me, False
    
    Me.Caption = mdlText.strTDITEMOUT
    ...
    If frmTHITEMOUT.Parent Then
        ...
        strWarehouseId = frmTHITEMOUT.WarehouseIdCombo
...
Private Sub FillText(Optional ByVal blnClear As Boolean = False)
    ...
    Else
        With rstMain
            ...
            If frmTHITEMOUT.Parent Then
                Me.txtStockQty.Caption = mdlProcedures.FormatCurrency(CStr(mdlTransaction.CheckStock(!ItemId, frmTHITEMOUT.WarehouseIdCombo)))
            End If
        End With
    End If
End Sub
