...
Begin VB.Form frmMISTHDOBUY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7605
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9165
   Icon            =   "frmMISTHDOBUY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHDOBUY"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHDOBUY
...
Private Sub SetGridHeader(Optional ByVal blnInitialize As Boolean = True)
    ...
    Set rstHeader = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "DOId, DODate, " & strTableFirst & ".POId", strTable, False, strCriteria, "DOId")
...
Private Sub SetGridDetail(Optional ByVal strDOId As String = "")
    Dim strTableFirst As String
    Dim strTableSecond As String
    Dim strTable As String
