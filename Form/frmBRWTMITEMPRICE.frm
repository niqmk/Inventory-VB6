...
Begin VB.Form frmBRWTMITEMPRICE 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   6135
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9270
   Icon            =   "frmBRWTMITEMPRICE.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6135
   ...
   End
End
Attribute VB_Name = "frmBRWTMITEMPRICE"
...
Private Sub dgdMain_HeadClick(ByVal ColIndex As Integer)
    ...
    If rstMain.RecordCount > 0 Then
        frmTMITEMPRICE.PriceId = rstMain!PriceId
    End If
End Sub
...
Private Sub cmdCancel_Click()
    If frmTMITEMPRICE.Parent Then
        frmTMITEMPRICE.PriceId = strParent
    End If
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strBRWTMITEMPRICE
    ...
    If frmTMITEMPRICE.Parent Then
        Me.txtItemId.Text = Trim(frmTMITEMPRICE.ItemId)
        Me.txtPartNumber.Text = Trim(frmTMITEMPRICE.PartNumber)
        Me.txtName.Text = Trim(frmTMITEMPRICE.ItemName)
        
        Dim strYear As String
        Dim strMonth As String
        
        strYear = mdlProcedures.FormatDate(frmTMITEMPRICE.PriceDate, "yyyy")
        strMonth = mdlProcedures.FormatDate(frmTMITEMPRICE.PriceDate, "MM")
        ...
        strParent = Trim(frmTMITEMPRICE.PriceId)
    End If
...
Private Sub SetGrid()
    ...
    If rstMain.RecordCount > 0 Then
        If frmTMITEMPRICE.Parent Then
            frmTMITEMPRICE.ItemId = rstMain!ItemId
        End If
    End If
