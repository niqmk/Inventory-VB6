...
Begin VB.Form frmMISTMSTOCKINIT 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   5550
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   10245
   Icon            =   "frmMISTMSTOCKINIT.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTMSTOCKINIT"
...
Private Sub SetGrid(Optional ByVal blnInitialize As Boolean = True)
    ...
    Else
        ...
        strCriteria = strCriteria & "WarehouseId='" & mdlProcedures.GetComboData(Me.cmbWarehouseId) & "'"
    End If
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, strTableFirst & ".ItemId, PartNumber, " & strTableSecond & ".Name, Qty, " & strTableSecond & ".UnityId", strTable, False, strCriteria, strTableFirst & ".ItemId ASC")
