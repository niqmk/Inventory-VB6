...
Begin VB.Form frmTMBRAND 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   3510
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "frmTMBRAND.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":B674
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMBRAND.frx":DAC6
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private PrintMaster As clsPRTTMBRAND
...
Private Sub txtBrandId_GotFocus()
    mdlProcedures.GotFocus Me.txtBrandId
End Sub
...
Private Sub SetInitialization()
    ...
    strFormCaption = mdlText.strTMBRAND
    
    blnParent = False
    blnActivate = False
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMBRAND, , , "BrandId ASC")
...
Private Sub SetMode()
    ...
    If objMode = AddMode Then
        ...
        Me.txtBrandId.SetFocus
    ElseIf objMode = UpdateMode Then
        Me.fraHeader.Enabled = False
        
        mdlProcedures.SetControlMode Me, objMode, False, Me.txtBrandId.Name
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMBRAND
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMBRAND, False, , "BrandId ASC")
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMITEM, "BrandId='" & rstMain!BrandId & "'") Then
            MsgBox strMessage & mdlText.strTMITEM & ")", vbOKOnly + vbExclamation, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        Else
            mdlDatabase.DeleteSingleRecord rstMain
            
            If frmTMITEM.Parent Then
                frmTMITEM.FillComboTMBRAND
            End If
        End If
    End If
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "BrandId", mdlProcedures.RepDupText(Trim(Me.txtBrandId.Text))
        
        If .EOF Then
            .AddNew
            
            !BrandId = mdlProcedures.RepDupText(Trim(Me.txtBrandId.Text))
...
Private Function CheckValidation() As Boolean
    If mdlProcedures.RepDupText(Trim(Me.txtBrandId.Text)) = "" Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            Me.txtBrandId.Text = Trim(!BrandId)
...
Public Property Get BrandId() As String
    If rstMain Is Nothing Then Exit Property

    If rstMain.RecordCount > 0 Then
        BrandId = rstMain!BrandId
    End If
End Property
...
Public Property Let BrandId(ByVal strBrandId As String)
    If rstMain Is Nothing Then Exit Property
    
    mdlDatabase.SearchRecordset rstMain, "BrandId", strBrandId
