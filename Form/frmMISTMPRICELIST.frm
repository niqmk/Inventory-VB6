...
Begin VB.Form frmMISTMPRICELIST 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   5670
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9270
   Icon            =   "frmMISTMPRICELIST.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTMPRICELIST"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTMPRICELIST
