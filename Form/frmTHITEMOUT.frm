...
Begin VB.Form frmTHITEMOUT 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7680
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9630
   Icon            =   "frmTHITEMOUT.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraHeader 
      ...
      Begin VB.CommandButton cmdWarehouseId 
         ...
         Width           =   375
      End
      Begin MSComCtl2.DTPicker dtpItemOutDate 
         Height          =   375
         Left            =   5760
         TabIndex        =   4
         Top             =   240
      ...
      Begin MSComctlLib.ImageList imlDetail 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":682E
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin MSComctlLib.Toolbar tlbMain 
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   7
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":D524
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":F976
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":11DC8
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":1236A
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHITEMOUT.frx":147BC
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTHITEMOUT"
...
Private PrintTransaction As clsPRTTHITEMOUT
...
Private Sub Form_Activate()
    ...
    If rstMain.RecordCount > 0 Then
        ...
        mdlProcedures.ShowForm frmBRWTHITEMOUT, False, True
    End If
...
Private Sub tlbDetail_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Select Case Button.Index
        Case AddDetailButton:
            ...
            mdlProcedures.ShowForm frmTDITEMOUT, False, True
...
Private Sub cmdSearch_Click()
    ...
    If CInt(mdlProcedures.FormatDate(Me.dtpItemOutDate.MinDate, "M")) >= CInt(strMonth) Then
        If CInt(mdlProcedures.FormatDate(Me.dtpItemOutDate.MinDate, "yyyy")) >= CInt(strYear) Then
            Me.dtpItemOutDate.MinDate = mdlProcedures.SetDate(strMonth, strYear)

            Me.dtpItemOutDate.MaxDate = mdlProcedures.SetDate(strMonth, strYear, , True)
        ElseIf CInt(mdlProcedures.FormatDate(Me.dtpItemOutDate.MinDate, "yyyy")) < CInt(strYear) Then
            Me.dtpItemOutDate.MaxDate = mdlProcedures.SetDate(strMonth, strYear, , True)

            Me.dtpItemOutDate.MinDate = mdlProcedures.SetDate(strMonth, strYear)
        End If
    ElseIf CInt(mdlProcedures.FormatDate(Me.dtpItemOutDate.MinDate, "M")) < CInt(strMonth) Then
        If CInt(mdlProcedures.FormatDate(Me.dtpItemOutDate.MinDate, "yyyy")) > CInt(strYear) Then
            Me.dtpItemOutDate.MinDate = mdlProcedures.SetDate(strMonth, strYear)
...
Private Sub txtItemOutId_GotFocus()
    mdlProcedures.GotFocus Me.txtItemOutId
End Sub
...
Private Sub dtpItemOutDate_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        SendKeys "{TAB}"
    End If
End Sub

Private Sub txtItemOutId_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        SendKeys "{TAB}"
    End If
End Sub
...
Private Sub SetInitialization()
    ...
    Me.dtpItemOutDate.CustomFormat = mdlGlobal.strFormatDate
    ...
    strFormCaption = mdlText.strTHITEMOUT
...
Private Sub SetRecordset()
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHITEMOUT, , "MONTH(ItemOutDate)=" & Me.MonthTrans & " AND YEAR(ItemOutDate)=" & Me.YearTrans, "ItemOutId ASC")
...
Private Sub SetMode()
    ...
    If objMode = AddMode Then
        ...
        Me.txtItemOutId.SetFocus
    ElseIf objMode = UpdateMode Then
        Me.fraHeader.Enabled = False

        mdlProcedures.SetControlMode Me, objMode, False, Me.txtItemOutId.Name, Me.cmbMonth.Name & " | " & Me.txtYear.Name
...
Private Sub PrintFunction()
    ...
    Set PrintTransaction = New clsPRTTHITEMOUT
    
    PrintTransaction.ImportToExcel rstMain!ItemOutId
End Sub
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        Set rstDetail = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "ItemId, Qty", mdlTable.CreateTDITEMOUT, False, "ItemOutId='" & rstMain!ItemOutId & "'")
        ...
        mdlTHITEMOUT.DeleteTHITEMOUT rstMain

        mdlDatabase.DeleteRecordQuery mdlGlobal.conInventory, mdlTable.CreateTDITEMOUT, "ItemOutId='" & rstMain!ItemOutId & "'"
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "ItemOutId", mdlProcedures.RepDupText(Trim(Me.txtItemOutId.Text))

        If .EOF Then
            .AddNew

            !ItemOutId = mdlProcedures.RepDupText(Trim(Me.txtItemOutId.Text))
            !ItemOutDate = mdlProcedures.FormatDate(Me.dtpItemOutDate.Value)
...
Private Sub SaveDetailFunction()
    ...
    strItemOutId = mdlProcedures.RepDupText(Trim(Me.txtItemOutId.Text))
    
    mdlDatabase.DeleteRecordQuery mdlGlobal.conInventory, mdlTable.CreateTHSTOCK, "ReferencesNumber='" & strItemOutId & "'"
    mdlDatabase.DeleteRecordQuery mdlGlobal.conInventory, mdlTable.CreateTDITEMOUT, "ItemOutId='" & strItemOutId & "'"

    If Not Me.flxDetail.Rows > 1 Then Exit Sub

    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTDITEMOUT, , "ItemOutId='" & strItemOutId & "'")
    ...
    With rstTemp
        If Not .RecordCount > 0 Then
            ...
            For lngRow = 1 To Me.flxDetail.Rows - 1
                ...
                !ItemOutId = strItemOutId
                !ItemOutDtlId = !ItemOutId & Trim(Me.flxDetail.TextMatrix(lngRow, ItemIdColumn))
...
Private Function CheckValidation() As Boolean
    If mdlProcedures.RepDupText(Trim(Me.txtItemOutId.Text)) = "" Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            Me.txtItemOutId.Text = Trim(!ItemOutId)
            Me.dtpItemOutDate.Value = mdlProcedures.FormatDate(!ItemOutDate, mdlGlobal.strFormatDate)
...
Private Sub FillGrid(Optional ByVal strItemOutId As String = "")
    With Me.flxDetail
        .Rows = 1

        Dim rstTemp As ADODB.Recordset

        Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTDITEMOUT, False, "ItemOutId='" & strItemOutId & "'", "ItemId ASC")
...
Public Sub FillComboTMWAREHOUSE()
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "WarehouseId, Name", mdlTable.CreateTMWAREHOUSE, False, , "WarehouseSet ASC")
...
Private Sub IncrementId()
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "ItemOutId", mdlTable.CreateTHITEMOUT, , "MONTH(ItemOutDate)=" & Me.MonthTrans & " AND YEAR(ItemOutDate)=" & Me.YearTrans)
    ...
    With rstTemp
        If .RecordCount > 0 Then
            ...
            While Not .EOF
                intNoSeq = ExtractSequential(Trim(!ItemOutId))
    ...
    strReferencesNumber = mdlText.strTHITEMOUT
    ...
    Me.txtItemOutId.Text = ZipId(intCounter)
    
    mdlDatabase.CloseRecordset rstTemp
End Sub

Private Function ExtractSequential(ByVal strItemOutId As String) As Integer
    Dim strExtract() As String

    strExtract = Split(strItemOutId, "/")
...
Private Function ZipId(ByVal intNoSeq As Integer) As String
    ZipId = _
        mdlText.strITEMOUTIDINIT & _
        "/" & _
        mdlProcedures.FormatDate(Me.dtpItemOutDate.Value, "yyyy") & _
        "/" & _
        mdlProcedures.FormatDate(Me.dtpItemOutDate.Value, "MM") & _
        "/" & _
...
Public Property Get ItemOutId() As String
    If rstMain Is Nothing Then Exit Property

    If rstMain.RecordCount > 0 Then
        ItemOutId = rstMain!ItemOutId
    End If
End Property
...
Public Property Let ItemOutId(ByVal strItemOutId As String)
    If rstMain Is Nothing Then Exit Property

    mdlDatabase.SearchRecordset rstMain, "ItemOutId", strItemOutId
