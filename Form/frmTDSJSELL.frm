...
Begin VB.Form frmTDSJSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   8175
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8910
   Icon            =   "frmTDSJSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8175
...
Private Sub cmdSave_Click()
    ...
    frmTHSJSELL.SaveDetail rstMain!ItemId, mdlProcedures.GetCurrency(Me.txtQty.Text), mdlProcedures.GetComboData(Me.cmbWarehouseId)
End Sub
...
Private Function CheckValidation() As Boolean
    If rstMain.RecordCount > 0 Then
        ...
        If Not (mdlProcedures.GetCurrency(Me.txtSOQty.Caption) >= curQty) Then
            MsgBox "Qty Melebihi Qty SO", vbOKOnly + vbExclamation, Me.Caption
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strTDSJSELL
...
Private Sub SetGrid(Optional ByVal blnInitialize As Boolean = True)
    ...
    strTableFirst = mdlTable.CreateTDSOSELL
    ...
    strCriteria = strCriteria & "SOId='" & frmTHSJSELL.SOIdCombo & "'"
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, strTableFirst & ".ItemId, PartNumber, " & strTableSecond & ".Name, Qty, SOId", strTable, False, strCriteria, strTableFirst & ".ItemId")
    ...
    With rstTemp
        While Not .EOF
            ...
            rstMain!Name = !Name
            rstMain!Qty = mdlProcedures.GetCurrency(!Qty) - mdlTHSJSELL.GetQtySOFromSJSELL(!SOId, !ItemId)
...
Private Sub FillText(Optional ByVal blnClear As Boolean = False)
    ...
    Else
        With rstMain
            ...
            Me.txtSOQty.Caption = mdlProcedures.FormatCurrency(!Qty)
