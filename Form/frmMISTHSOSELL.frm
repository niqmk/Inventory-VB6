...
Begin VB.Form frmMISTHSOSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7725
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9285
   Icon            =   "frmMISTHSOSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMISTHSOSELL"
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strMISTHSOSELL
...
Private Sub SetGridHeader(Optional ByVal blnInitialize As Boolean = True)
    ...
    Set rstHeader = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "SOId, SODate, POId, Disc, Tax", mdlTable.CreateTHSOSELL, False, strCriteria, "SOId ASC")
    ...
    With Me.dgdHeader
        ...
        .Columns(2).Width = 2450
        .Columns(2).Locked = True
        .Columns(2).Caption = "Nomor PO"
        .Columns(3).Width = 600
        .Columns(3).Locked = True
        .Columns(3).Caption = "Disc (%)"
        .Columns(3).NumberFormat = "#,##0"
        .Columns(3).Alignment = dbgRight
        .Columns(4).Width = 600
        .Columns(4).Locked = True
        .Columns(4).Caption = "PPN (%)"
        .Columns(4).NumberFormat = "#,##0"
        .Columns(4).Alignment = dbgRight
    End With
End Sub

Private Sub SetGridDetail(Optional ByVal strSOId As String = "")
