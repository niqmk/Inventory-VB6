...
Begin VB.Form frmTMUNITY 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   3495
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "frmTMUNITY.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":43DC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":B674
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTMUNITY.frx":DAC6
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private PrintMaster As clsPRTTMUNITY
...
Private Sub txtUnityId_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub SetInitialization()
    ...
    strFormCaption = mdlText.strTMUNITY
    
    blnParent = False
    
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMUNITY, , , "UnityId ASC")
...
Private Sub SetMode()
    ...
    If objMode = AddMode Then
        ...
        Me.txtUnityId.SetFocus
    ElseIf objMode = UpdateMode Then
        Me.fraHeader.Enabled = False
        
        mdlProcedures.SetControlMode Me, objMode, False, Me.txtUnityId.Name
...
Private Sub PrintFunction()
    ...
    Set PrintMaster = New clsPRTTMUNITY
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTMUNITY, False, , "UnityId ASC")
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTMITEM, "UnityId='" & rstMain!UnityId & "'") Then
...
Private Sub SaveFunction()
    ...
    With rstMain
        mdlDatabase.SearchRecordset rstMain, "UnityId", mdlProcedures.RepDupText(Trim(Me.txtUnityId.Text))
        
        If .EOF Then
            .AddNew
            
            !UnityId = mdlProcedures.RepDupText(Trim(Me.txtUnityId.Text))
...
Private Function CheckValidation() As Boolean
    If mdlProcedures.RepDupText(Trim(Me.txtUnityId.Text)) = "" Then
...
Private Sub FillText()
    With rstMain
        If .RecordCount > 0 Then
            Me.txtUnityId.Text = Trim(!UnityId)
...
Public Property Get UnityId() As String
    If rstMain Is Nothing Then Exit Property

    If rstMain.RecordCount > 0 Then
        UnityId = rstMain!UnityId
    End If
End Property

Public Property Get UnityName() As String
    If rstMain Is Nothing Then Exit Property

    If rstMain.RecordCount > 0 Then
        UnityName = rstMain!Name
    End If
End Property
...
Public Property Let UnityId(ByVal strUnityId As String)
    If rstMain Is Nothing Then Exit Property
    
    mdlDatabase.SearchRecordset rstMain, "UnityId", strUnityId
