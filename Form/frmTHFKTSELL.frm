...
Begin VB.Form frmTHFKTSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   7815
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9255
   Icon            =   "frmTHFKTSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList imlDetail 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":1F8A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":43DC
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin MSComctlLib.Toolbar tlbMain 
      ...
      Begin MSComctlLib.ImageList imlMain 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   7
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":682E
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":8C80
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":B0D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":D524
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":F976
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":FF18
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmTHFKTSELL.frx":1236A
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmTHFKTSELL"
...
Private PrintTransaction As clsPRTTHFKTSELL
...
Private Sub tlbDetail_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        Case AddDetailButton:
            If Not mdlProcedures.IsValidComboData(Me.cmbCustomerId) Then
                MsgBox "Customer Harap Dipilih Terlebih Dahulu", vbOKOnly + vbExclamation, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
            ...
            mdlProcedures.ShowForm frmTDFKTSELL, False, True
...
Private Sub SetInitialization()
    ...
    strFormCaption = mdlText.strTHFKTSELL
...
Private Sub SetRecordset()
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHFKTSELL, , "MONTH(FktDate)=" & Me.MonthTrans & " AND YEAR(FktDate)=" & Me.YearTrans, "FktId ASC")
...
Private Sub PrintFunction()
    ...
    Set PrintTransaction = New clsPRTTHFKTSELL
...
Private Sub DeleteFunction()
    ...
    If mdlProcedures.SetMsgYesNo("Apakah Anda Yakin ?", mdlProcedures.SetCaptionMode(strFormCaption, objMode)) Then
        ...
        If mdlDatabase.IsDataExists(mdlGlobal.conInventory, mdlTable.CreateTHRTRSELL, "FktId='" & rstMain!FktId & "'") Then
            MsgBox strMessage & mdlText.strTHRTRSELL & ")", vbCritical + vbOKOnly, mdlProcedures.SetCaptionMode(strFormCaption, objMode)
        Else
            mdlTHFKTSELL.DeleteTHFKTSELL rstMain
        
            mdlDatabase.DeleteRecordQuery mdlGlobal.conInventory, mdlTable.CreateTDFKTSELL, "FktId='" & rstMain!FktId & "'"
            mdlDatabase.DeleteSingleRecord rstMain
            
            If frmTHRTRSELL.Parent Then
                frmTHRTRSELL.FillComboTHFKTSELL
            End If
...
Private Sub SaveDetailFunction()
    ...
    mdlDatabase.DeleteRecordQuery mdlGlobal.conInventory, mdlTable.CreateTDFKTSELL, "FktId='" & strFktId & "'"

    If Not Me.flxDetail.Rows > 1 Then Exit Sub
    
    Dim rstTemp As ADODB.Recordset
    
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTDFKTSELL, , "FktId='" & strFktId & "'")
...
Private Sub FillGrid(Optional ByVal strFktId As String = "")
    With Me.flxDetail
        ...
        Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTDFKTSELL, False, "FktId='" & strFktId & "'")
        
        While Not rstTemp.EOF
            .Rows = .Rows + 1
        
            .TextMatrix(.Rows - 1, SJIdColumn) = rstTemp!SJId
            .TextMatrix(.Rows - 1, SJDateColumn) = mdlProcedures.FormatDate(mdlDatabase.GetFieldData(mdlGlobal.conInventory, "SJDate", mdlTable.CreateTHSJSELL, "SJId='" & rstTemp!SJId & "'"), "dd MMMM yyyy")
            .TextMatrix(.Rows - 1, QtyColumn) = mdlProcedures.FormatCurrency(CStr(mdlTHSJSELL.GetTotalQtySJSELL(rstTemp!SJId)))
...
Public Sub FillComboTMCUSTOMER()
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "CustomerId, Name", mdlTable.CreateTMCUSTOMER, False, "StatusYN='" & mdlGlobal.strYes & "'", "CustomerId ASC")
...
Public Function SaveDetail(ByVal strSJId As String) As Boolean
    With Me.flxDetail
        ...
        If Not blnExist Then
            ...
            .TextMatrix(.Rows - 1, SJDateColumn) = mdlProcedures.FormatDate(mdlDatabase.GetFieldData(mdlGlobal.conInventory, "SJDate", mdlTable.CreateTHSJSELL, "SJId='" & strSJId & "'"), "dd MMMM yyyy")
            .TextMatrix(.Rows - 1, QtyColumn) = mdlProcedures.FormatCurrency(CStr(mdlTHSJSELL.GetTotalQtySJSELL(strSJId)))
...
Private Sub IncrementId()
    ...
    Set rstTemp = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "FktId", mdlTable.CreateTHFKTSELL, , "MONTH(FktDate)=" & Me.MonthTrans & " AND YEAR(FktDate)=" & Me.YearTrans)
    ...
    strReferencesNumber = mdlText.strFKTIDINIT & "/" & mdlText.strSELLINIT
...
Private Sub FillInfo(Optional ByVal blnClear As Boolean = False)
    ...
    strSOId = mdlDatabase.GetFieldData(mdlGlobal.conInventory, "SOId", mdlTable.CreateTHSJSELL, "SJId='" & strSJId & "'")
    ...
    strPODate = mdlDatabase.GetFieldData(mdlGlobal.conInventory, "PODate", mdlTable.CreateTHPOSELL, "POId='" & strPOId & "'")
