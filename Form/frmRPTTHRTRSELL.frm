...
Begin VB.Form frmRPTTHRTRSELL 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   2685
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9255
   Icon            =   "frmRPTTHRTRSELL.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRPTTHRTRSELL"
...
Private PrintReport As clsRPTTHRTRSELL
...
Private Sub SetInitialization()
    ...
    Me.Caption = mdlText.strRPTTHRTRSELL
...
Private Sub SetPrint()
    ...
    Set rstMain = mdlDatabase.OpenRecordset(mdlGlobal.conInventory, "*", mdlTable.CreateTHRTRSELL, False, strCriteria, "RtrId ASC")
    ...
    Else
        ...
        Set PrintReport = New clsRPTTHRTRSELL
